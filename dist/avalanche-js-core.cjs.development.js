...
var crypto = require('avalanche-js-crypto');
var utils = require('avalanche-js-utils');
var avalancheJsNetwork = require('avalanche-js-network');
var avalancheJsTransaction = require('avalanche-js-transaction');
var avalancheJsStaking = require('avalanche-js-staking');
var avalancheJsContract = require('avalanche-js-contract');
...
var Blockchain = /*#__PURE__*/function () {
  ...
  _proto.getRpcResult = function getRpcResult(result) {
    if (result instanceof avalancheJsNetwork.ResponseMiddleware) {
      ...
      return _regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              address = _ref.address, _ref$blockNumber = _ref.blockNumber, blockNumber = _ref$blockNumber === void 0 ? utils.DefaultBlockParams.latest : _ref$blockNumber, _ref$shardID = _ref.shardID, shardID = _ref$shardID === void 0 ? this.messenger.currentShard : _ref$shardID;
              _context.next = 3;
              return this.messenger.send(avalancheJsNetwork.RPCMethod.GetBalance, [crypto.getAddress(address).checksum, blockNumber], this.messenger.chainPrefix, shardID);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 3;
              return this.messenger.send(avalancheJsNetwork.RPCMethod.BlockNumber, [], this.messenger.chainPrefix, shardID);
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 3;
              return this.messenger.send(avalancheJsNetwork.RPCMethod.GetBlockByHash, [blockHash, returnObject], this.messenger.chainPrefix, shardID);
      ...
      return _regeneratorRuntime.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              _ref3$blockNumber = _ref3.blockNumber, blockNumber = _ref3$blockNumber === void 0 ? utils.DefaultBlockParams.latest : _ref3$blockNumber, _ref3$returnObject = _ref3.returnObject, returnObject = _ref3$returnObject === void 0 ? true : _ref3$returnObject, _ref3$shardID = _ref3.shardID, shardID = _ref3$shardID === void 0 ? this.messenger.currentShard : _ref3$shardID;
              _context4.next = 3;
              return this.messenger.send(avalancheJsNetwork.RPCMethod.GetBlockByNumber, [blockNumber, returnObject], this.messenger.chainPrefix, shardID);
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              _context5.next = 3;
              return this.messenger.send(avalancheJsNetwork.RPCMethod.GetBlockTransactionCountByHash, [blockHash], this.messenger.chainPrefix, shardID);
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              _context6.next = 3;
              return this.messenger.send(avalancheJsNetwork.RPCMethod.GetBlockTransactionCountByNumber, [blockNumber], this.messenger.chainPrefix, shardID);
        ...
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              ...
              _context7.next = 3;
              return this.messenger.send(avalancheJsNetwork.RPCMethod.GetTransactionByBlockHashAndIndex, [blockHash, index], this.messenger.chainPrefix, shardID);
      ...
      return _regeneratorRuntime.wrap(function _callee8$(_context8) {
        while (1) {
          switch (_context8.prev = _context8.next) {
            case 0:
              _ref7$blockNumber = _ref7.blockNumber, blockNumber = _ref7$blockNumber === void 0 ? utils.DefaultBlockParams.latest : _ref7$blockNumber, index = _ref7.index, _ref7$shardID = _ref7.shardID, shardID = _ref7$shardID === void 0 ? this.messenger.currentShard : _ref7$shardID;
              _context8.next = 3;
              return this.messenger.send(avalancheJsNetwork.RPCMethod.GetTransactionByBlockNumberAndIndex, [blockNumber, index], this.messenger.chainPrefix, shardID);
        ...
        while (1) {
          switch (_context9.prev = _context9.next) {
            case 0:
              ...
              _context9.next = 3;
              return this.messenger.send(avalancheJsNetwork.RPCMethod.GetTransactionByHash, [txnHash], this.messenger.chainPrefix, shardID);
        ...
        while (1) {
          switch (_context10.prev = _context10.next) {
            case 0:
              ...
              _context10.next = 3;
              return this.messenger.send(avalancheJsNetwork.RPCMethod.GetTransactionReceipt, [txnHash], this.messenger.chainPrefix, shardID);
        ...
        while (1) {
          switch (_context11.prev = _context11.next) {
            case 0:
              ...
              _context11.next = 3;
              return this.messenger.send(avalancheJsNetwork.RPCMethod.GetCXReceiptByHash, [txnHash], this.messenger.chainPrefix, shardID);
      ...
      return _regeneratorRuntime.wrap(function _callee12$(_context12) {
        while (1) {
          switch (_context12.prev = _context12.next) {
            case 0:
              address = _ref11.address, _ref11$blockNumber = _ref11.blockNumber, blockNumber = _ref11$blockNumber === void 0 ? utils.DefaultBlockParams.latest : _ref11$blockNumber, _ref11$shardID = _ref11.shardID, shardID = _ref11$shardID === void 0 ? this.messenger.currentShard : _ref11$shardID;
              _context12.next = 3;
              return this.messenger.send(avalancheJsNetwork.RPCMethod.GetCode, [crypto.getAddress(address).checksum, blockNumber], this.messenger.chainPrefix, shardID);
        ...
        while (1) {
          switch (_context13.prev = _context13.next) {
            case 0:
              ...
              _context13.next = 3;
              return this.messenger.send(avalancheJsNetwork.RPCMethod.PeerCount, [], 'net', shardID);
        ...
        while (1) {
          switch (_context14.prev = _context14.next) {
            case 0:
              ...
              _context14.next = 3;
              return this.messenger.send(avalancheJsNetwork.RPCMethod.NetVersion, [], 'net', shardID);
        ...
        while (1) {
          switch (_context15.prev = _context15.next) {
            case 0:
              ...
              _context15.next = 3;
              return this.messenger.send(avalancheJsNetwork.RPCMethod.ProtocolVersion, [], this.messenger.chainPrefix, shardID);
      ...
      return _regeneratorRuntime.wrap(function _callee16$(_context16) {
        while (1) {
          switch (_context16.prev = _context16.next) {
            case 0:
              address = _ref12.address, position = _ref12.position, _ref12$blockNumber = _ref12.blockNumber, blockNumber = _ref12$blockNumber === void 0 ? utils.DefaultBlockParams.latest : _ref12$blockNumber, _ref12$shardID = _ref12.shardID, shardID = _ref12$shardID === void 0 ? this.messenger.currentShard : _ref12$shardID;
              _context16.next = 3;
              return this.messenger.send(avalancheJsNetwork.RPCMethod.GetStorageAt, [crypto.getAddress(address).checksum, position, blockNumber], this.messenger.chainPrefix, shardID);
      ...
      return _regeneratorRuntime.wrap(function _callee17$(_context17) {
        while (1) {
          switch (_context17.prev = _context17.next) {
            case 0:
              address = _ref13.address, _ref13$blockNumber = _ref13.blockNumber, blockNumber = _ref13$blockNumber === void 0 ? utils.DefaultBlockParams.latest : _ref13$blockNumber, _ref13$shardID = _ref13.shardID, shardID = _ref13$shardID === void 0 ? this.messenger.currentShard : _ref13$shardID;
              _context17.next = 3;
              return this.messenger.send(avalancheJsNetwork.RPCMethod.GetTransactionCount, [crypto.getAddress(address).checksum, blockNumber], this.messenger.chainPrefix, shardID);
      ...
      return _regeneratorRuntime.wrap(function _callee18$(_context18) {
        while (1) {
          switch (_context18.prev = _context18.next) {
            case 0:
              _context18.next = 2;
              return this.messenger.send(avalancheJsNetwork.RPCMethod.GetShardingStructure, [], this.messenger.chainPrefix);
      ...
      return _regeneratorRuntime.wrap(function _callee19$(_context19) {
        while (1) {
          switch (_context19.prev = _context19.next) {
            ...
            case 2:
              _context19.next = 4;
              return this.messenger.send(avalancheJsNetwork.RPCMethod.SendRawTransaction, [transaction.getRawTransaction()], this.messenger.chainPrefix, typeof transaction.txParams.shardID === 'string' ? Number.parseInt(transaction.txParams.shardID, 10) : transaction.txParams.shardID);
        ...
        while (1) {
          switch (_context22.prev = _context22.next) {
            case 0:
              ...
              _context22.next = 3;
              return this.messenger.send(avalancheJsNetwork.RPCMethod.EstimateGas, [{
                to: crypto.getAddress(to).checksum,
                data: data
        ...
        while (1) {
          switch (_context23.prev = _context23.next) {
            case 0:
              ...
              _context23.next = 3;
              return this.messenger.send(avalancheJsNetwork.RPCMethod.GasPrice, [], this.messenger.chainPrefix, shardID);
      ...
      return _regeneratorRuntime.wrap(function _callee24$(_context24) {
        while (1) {
          switch (_context24.prev = _context24.next) {
            case 0:
              payload = _ref15.payload, _ref15$blockNumber = _ref15.blockNumber, blockNumber = _ref15$blockNumber === void 0 ? utils.DefaultBlockParams.latest : _ref15$blockNumber, _ref15$shardID = _ref15.shardID, shardID = _ref15$shardID === void 0 ? this.messenger.currentShard : _ref15$shardID;
              _context24.next = 3;
              return this.messenger.send(avalancheJsNetwork.RPCMethod.Call, [payload, blockNumber], this.messenger.chainPrefix, shardID);
  ...
  _proto.newPendingTransactions = function newPendingTransactions(shardID) {
    ...
    if (this.messenger.provider instanceof avalancheJsNetwork.WSProvider) {
      return new avalancheJsNetwork.NewPendingTransactions(this.messenger, shardID);
    } else {
  ...
  _proto.newBlockHeaders = function newBlockHeaders(shardID) {
    ...
    if (this.messenger.provider instanceof avalancheJsNetwork.WSProvider) {
      return new avalancheJsNetwork.NewHeaders(this.messenger, shardID);
    } else {
      throw new Error('HttpProvider does not support this feature');
    }
  }
  ...
  _proto.syncing = function syncing(shardID) {
    ...
    if (this.messenger.provider instanceof avalancheJsNetwork.WSProvider) {
      return new avalancheJsNetwork.Syncing(this.messenger, shardID);
    } else {
      throw new Error('HttpProvider does not support this feature');
    }
  }
  ...
  _proto.logs = function logs(options, shardID) {
    ...
    if (this.messenger.provider instanceof avalancheJsNetwork.WSProvider) {
      return new avalancheJsNetwork.LogSub(options, this.messenger, shardID);
    } else {
      throw new Error('HttpProvider does not support this feature');
    }
  };
...
tslib.__decorate([utils.assertObject({
  address: ['isValidAddress', utils.AssertType.required],
  blockNumber: ['isBlockNumber', utils.AssertType.optional],
  shardID: ['isNumber', utils.AssertType.optional]
})], Blockchain.prototype, "getBalance", null);

tslib.__decorate([utils.assertObject({
  blockHash: ['isHash', utils.AssertType.required],
  returnObject: ['isBoolean', utils.AssertType.optional],
  shardID: ['isNumber', utils.AssertType.optional]
...
tslib.__decorate([utils.assertObject({
  blockNumber: ['isBlockNumber', utils.AssertType.required],
  shardID: ['isNumber', utils.AssertType.optional]
})], Blockchain.prototype, "getBlockTransactionCountByNumber", null);

tslib.__decorate([utils.assertObject({
  blockHash: ['isHash', utils.AssertType.required],
  index: ['isHex', utils.AssertType.required],
  shardID: ['isNumber', utils.AssertType.optional]
...
tslib.__decorate([utils.assertObject({
  txnHash: ['isHash', utils.AssertType.required],
  shardID: ['isNumber', utils.AssertType.optional]
})], Blockchain.prototype, "getTransactionByHash", null);

tslib.__decorate([utils.assertObject({
  txnHash: ['isString', utils.AssertType.required],
  shardID: ['isNumber', utils.AssertType.optional]
})], Blockchain.prototype, "getTransactionReceipt", null);

tslib.__decorate([utils.assertObject({
  txnHash: ['isString', utils.AssertType.required],
  shardID: ['isNumber', utils.AssertType.required]
...
tslib.__decorate([utils.assertObject({
  address: ['isValidAddress', utils.AssertType.required],
  position: ['isHex', utils.AssertType.required],
  blockNumber: ['isBlockNumber', utils.AssertType.optional],
  shardID: ['isNumber', utils.AssertType.optional]
...
tslib.__decorate([utils.assertObject({
  to: ['isValidAddress', utils.AssertType.optional],
  data: ['isHex', utils.AssertType.optional],
  shardID: ['isNumber', utils.AssertType.optional]
...
var Avalanche = /*#__PURE__*/function (_utils$AvalancheCore) {
  ...
  function Avalanche(url, config) {
    ...
    _this.Modules = {
      HttpProvider: avalancheJsNetwork.HttpProvider,
      WSProvider: avalancheJsNetwork.WSProvider,
      Messenger: avalancheJsNetwork.Messenger,
      Blockchain: Blockchain,
      TransactionFactory: avalancheJsTransaction.TransactionFactory,
      StakingFactory: avalancheJsStaking.StakingFactory,
      Wallet: avalancheJsAccount.Wallet,
      Transaction: avalancheJsTransaction.Transaction,
      StakingTransaction: avalancheJsStaking.StakingTransaction,
      Account: avalancheJsAccount.Account,
      Contract: avalancheJsContract.Contract
    };
    var providerUrl = config.chainUrl || url || utils.defaultConfig.Default.Chain_URL;
    _this.provider = new avalancheJsNetwork.Provider(providerUrl).provider;
    _this.messenger = new avalancheJsNetwork.Messenger(_this.provider, _this.chainType, _this.chainId);
    _this.blockchain = new Blockchain(_this.messenger);
    _this.transactions = new avalancheJsTransaction.TransactionFactory(_this.messenger);
    _this.stakings = new avalancheJsStaking.StakingFactory(_this.messenger);
    _this.wallet = new avalancheJsAccount.Wallet(_this.messenger);
    _this.contracts = new avalancheJsContract.ContractFactory(_this.wallet);
    _this.crypto = crypto;
    _this.utils = utils;
  ...
  _proto.setProvider = function setProvider(provider) {
    this.provider = new avalancheJsNetwork.Provider(provider).provider;
...
var TruffleProvider = /*#__PURE__*/function (_HDNode) {
  ...
  function TruffleProvider(provider, hdOptions, chainOptions, transactionOptions) {
    ...
    if (chainOptions === void 0) {
      chainOptions = {
        shardID: 0,
        chainType: utils.ChainType.Avalanche,
            ...
            case 23:
              ...
              return this.provider.send(newArgs, function (err, res) {
                try {
                  ...
                  if (new utils.Unit(response.result.gasLimit).asWei().toWei().gt(new utils.Unit(_this2.gasLimit).asWei().toWei())) {
                    response.result.gasLimit = "0x" + new utils.Unit(_this2.gasLimit).asWei().toWei().toString('hex');
                  }
...
var AvalancheExtension = /*#__PURE__*/function () {
  ...
  function AvalancheExtension(wallet, config) {
    ...
    if (wallet.messenger) {
      ...
      this.provider = new avalancheJsNetwork.Provider(config.chainUrl || wallet.network.chain_url).provider;
      this.messenger = new avalancheJsNetwork.Messenger(this.provider, config.chainType, config.chainId);
    }

    this.wallet.messenger = this.messenger;
    this.blockchain = new Blockchain(this.messenger);
    this.transactions = new avalancheJsTransaction.TransactionFactory(this.messenger);
    this.contracts = new avalancheJsContract.ContractFactory(this.wallet);
    this.crypto = crypto;
    this.utils = utils;
  }
  /**
  ...
  _proto.isExtension = function isExtension(wallet) {
    ...
    if (wallet.isMathWallet || wallet.isAVAXWallet) {
      isExtension = true;
      if (wallet.isMathWallet) this.extensionType = exports.ExtensionType.MathWallet;else this.extensionType = exports.ExtensionType.AVAXWallet; // remake signTransaction of MathWallet or AVAXWallet
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 5:
                  ...
                  _context.next = 9;
                  return _this.messenger.send(avalancheJsNetwork.RPCMethod.GetAccountNonce, [crypto.getAddress(extensionAccount.address).checksum, blockNumber], _this.messenger.chainPrefix, typeof transaction.txParams.shardID === 'string' ? Number.parseInt(transaction.txParams.shardID, 10) : transaction.txParams.shardID);
...
exports.AvalancheExtension = AvalancheExtension;
exports.Blockchain = Blockchain;
exports.TruffleProvider = TruffleProvider;
//# sourceMappingURL=avalanche-js-core.cjs.development.js.map
